...
const SliderContent = () => {
  ...
  return (
    <div className="rounded-xl bg-gray-500/30 shadow-xl bg-clip-padding backdrop-filter  backdrop-blur-md backdrop-saturate-100 backdrop-contrast-100 border-2 border-secondary px-5 sm:px-10 py-10 absolute top-1/2 left-1/2 -translate-x-1/2 w-[85%] sm:w-[30rem] md:w-[40rem] lg:w-[45rem] -translate-y-1/2">
            ...
            <div>
              ...
              >
                <input
                  className="border sm:block border-secondary w-[70%] sm:w-1/2 placeholder:text-secondary px-4 sm:py-1 py-1 bg-gray-300 font-madimi rounded-l-2xl sm:text-base text-sm"
                  type="text"
                ...
                <div className="flex text-white items-center relative">
                  ...
                  <button
                    className="border sm:block hidden border-secondary sm:text-base text-sm cursor-pointer sm:py-1 pl-9 pr-4 py-1 bg-primary font-madimi rounded-r-2xl"
                    type="submit"
                  >
                    Search
                  </button>
